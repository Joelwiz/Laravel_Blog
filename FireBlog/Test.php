...
$entry1 = new Entrada("El Pepe Chiringo","12/06/2007","Es un restaurante de comida rapida.",$nombre1,"pepe.png","#IRL","Vida Real");
$entry2 = new Entrada("Smash Ultimate","23/09/2020","Es un juegazo de lucha.",$nombre2,"smash.jpg.","#Game #Fighting","Videojuegos");
$entry3 = new Entrada("Plato de Espaguetis Boloñesa","11/09/2013","Un plato buenisimo de pasta.",$nombre4,"Bolognesa.jpg.","#Cooking #Recipe","Comida");
$entry4 = new Entrada("Regalos bien envueltos","02/12/2018","Como envolver bien un regalo de navidad.",$nombre3,"present.jpg","#Presents #Holidays #Christmas","Regalos");
...
foreach ($data2 as $key=>$value){
    ...
    echo "<br>";
    echo "<img style='height: 300px;width: 275px' src='img/"."$k"."'>";
    echo "<br>";
